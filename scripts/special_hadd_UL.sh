...
echo "rm -f ${HADDDIR}/vbshwwlvlvbb_c2v.root; hadd -f ${HADDDIR}/vbshwwlvlvbb_c2v.root                                          hadds/${ULTAG}/${BABYVERSION}/${STUDY}_2017/vbshwwlvlvbb_c2v.root hadds/${ULTAG}/${BABYVERSION}/${STUDY}_2018/vbshwwlvlvbb_c2v.root  > ${HADDDIR}/vbshwwlvlvbb_c2v.hadd.log 2>&1" >> .haddjobs.txt
echo "rm -f ${HADDDIR}/vbshwwlvlvbb_cv.root ; hadd -f ${HADDDIR}/vbshwwlvlvbb_cv.root                                           hadds/${ULTAG}/${BABYVERSION}/${STUDY}_2017/vbshwwlvlvbb_cv.root  hadds/${ULTAG}/${BABYVERSION}/${STUDY}_2018/vbshwwlvlvbb_cv.root   > ${HADDDIR}/vbshwwlvlvbb_cv.hadd.log 2>&1" >> .haddjobs.txt
echo "rm -f ${HADDDIR}/vbshwwlvlvbb_c3.root ; hadd -f ${HADDDIR}/vbshwwlvlvbb_c3.root                                           hadds/${ULTAG}/${BABYVERSION}/${STUDY}_2017/vbshwwlvlvbb_c3.root  hadds/${ULTAG}/${BABYVERSION}/${STUDY}_2018/vbshwwlvlvbb_c3.root   > ${HADDDIR}/vbshwwlvlvbb_c3.hadd.log 2>&1" >> .haddjobs.txt
