...
namespace ttH {
    ...
    float getElecTTHSFErr(float eta, float pt, int year); // Note: use this one! // TODO: check this!
    ...
    float getMuonTTHSFErr(float eta, float pt, int year); // Note: use this one! // TODO: check this!
