...
float ttH::getElecRecoEffSF(float eta, float pt, int year) {
    ...
    if (year == 2018) {
        if (fabs(eta) >= -2.5 && fabs(eta) < -2 && pt >= 10 && pt < 20) return 1.01998;
        if (fabs(eta) >= -2.5 && fabs(eta) < -2 && pt >= 20 && pt < 45) return 0.986556;
        if (fabs(eta) >= -2.5 && fabs(eta) < -2 && pt >= 45 && pt < 75) return 0.98768;
        if (fabs(eta) >= -2.5 && fabs(eta) < -2 && pt >= 75 && pt < 100) return 1.00206;
        if (fabs(eta) >= -2.5 && fabs(eta) < -2 && pt >= 100) return 0.983673;
        if (fabs(eta) >= -2 && fabs(eta) < -1.566 && pt >= 10 && pt < 20) return 0.983351;
        if (fabs(eta) >= -2 && fabs(eta) < -1.566 && pt >= 20 && pt < 45) return 0.986639;
        if (fabs(eta) >= -2 && fabs(eta) < -1.566 && pt >= 45 && pt < 75) return 0.988764;
        if (fabs(eta) >= -2 && fabs(eta) < -1.566 && pt >= 75 && pt < 100) return 1.01837;
        if (fabs(eta) >= -2 && fabs(eta) < -1.566 && pt >= 100) return 0.997967;
        if (fabs(eta) >= -1.566 && fabs(eta) < -1.444 && pt >= 10 && pt < 20) return 1.25678;
        if (fabs(eta) >= -1.566 && fabs(eta) < -1.444 && pt >= 20 && pt < 45) return 0.986095;
        if (fabs(eta) >= -1.566 && fabs(eta) < -1.444 && pt >= 45 && pt < 75) return 0.967672;
        if (fabs(eta) >= -1.566 && fabs(eta) < -1.444 && pt >= 75 && pt < 100) return 1.04381;
        if (fabs(eta) >= -1.566 && fabs(eta) < -1.444 && pt >= 100) return 1.03668;
        if (fabs(eta) >= -1.444 && fabs(eta) < -1 && pt >= 10 && pt < 20) return 1.0307;
        if (fabs(eta) >= -1.444 && fabs(eta) < -1 && pt >= 20 && pt < 45) return 0.987526;
        if (fabs(eta) >= -1.444 && fabs(eta) < -1 && pt >= 45 && pt < 75) return 0.989691;
        if (fabs(eta) >= -1.444 && fabs(eta) < -1 && pt >= 75 && pt < 100) return 1.00818;
        if (fabs(eta) >= -1.444 && fabs(eta) < -1 && pt >= 100) return 1.00718;
        if (fabs(eta) >= -1 && fabs(eta) < -0.5 && pt >= 10 && pt < 20) return 0.971215;
        if (fabs(eta) >= -1 && fabs(eta) < -0.5 && pt >= 20 && pt < 45) return 0.99177;
        if (fabs(eta) >= -1 && fabs(eta) < -0.5 && pt >= 45 && pt < 75) return 0.989775;
        if (fabs(eta) >= -1 && fabs(eta) < -0.5 && pt >= 75 && pt < 100) return 1.00815;
        if (fabs(eta) >= -1 && fabs(eta) < -0.5 && pt >= 100) return 1.0061;
        if (fabs(eta) >= -0.5 && fabs(eta) < 0 && pt >= 10 && pt < 20) return 0.974973;
        if (fabs(eta) >= -0.5 && fabs(eta) < 0 && pt >= 20 && pt < 45) return 0.98968;
        if (fabs(eta) >= -0.5 && fabs(eta) < 0 && pt >= 45 && pt < 75) return 0.989754;
        if (fabs(eta) >= -0.5 && fabs(eta) < 0 && pt >= 75 && pt < 100) return 1.00305;
        if (fabs(eta) >= -0.5 && fabs(eta) < 0 && pt >= 100) return 1.00304;
        if (fabs(eta) >= 0 && fabs(eta) < 0.5 && pt >= 10 && pt < 20) return 0.974973;
        if (fabs(eta) >= 0 && fabs(eta) < 0.5 && pt >= 20 && pt < 45) return 0.996894;
        if (fabs(eta) >= 0 && fabs(eta) < 0.5 && pt >= 45 && pt < 75) return 0.996914;
        if (fabs(eta) >= 0 && fabs(eta) < 0.5 && pt >= 75 && pt < 100) return 1.02156;
        if (fabs(eta) >= 0 && fabs(eta) < 0.5 && pt >= 100) return 1.00304;
        if (fabs(eta) >= 0.5 && fabs(eta) < 1 && pt >= 10 && pt < 20) return 0.971215;
        if (fabs(eta) >= 0.5 && fabs(eta) < 1 && pt >= 20 && pt < 45) return 0.998968;
        if (fabs(eta) >= 0.5 && fabs(eta) < 1 && pt >= 45 && pt < 75) return 0.997947;
        if (fabs(eta) >= 0.5 && fabs(eta) < 1 && pt >= 75 && pt < 100) return 1.01947;
        if (fabs(eta) >= 0.5 && fabs(eta) < 1 && pt >= 100) return 1.0061;
        if (fabs(eta) >= 1 && fabs(eta) < 1.444 && pt >= 10 && pt < 20) return 1.0307;
        if (fabs(eta) >= 1 && fabs(eta) < 1.444 && pt >= 20 && pt < 45) return 0.9875;
        if (fabs(eta) >= 1 && fabs(eta) < 1.444 && pt >= 45 && pt < 75) return 0.989669;
        if (fabs(eta) >= 1 && fabs(eta) < 1.444 && pt >= 75 && pt < 100) return 1.01028;
        if (fabs(eta) >= 1 && fabs(eta) < 1.444 && pt >= 100) return 1.00718;
        if (fabs(eta) >= 1.444 && fabs(eta) < 1.566 && pt >= 10 && pt < 20) return 1.25678;
        if (fabs(eta) >= 1.444 && fabs(eta) < 1.566 && pt >= 20 && pt < 45) return 0.973193;
        if (fabs(eta) >= 1.444 && fabs(eta) < 1.566 && pt >= 45 && pt < 75) return 0.980392;
        if (fabs(eta) >= 1.444 && fabs(eta) < 1.566 && pt >= 75 && pt < 100) return 1.03533;
        if (fabs(eta) >= 1.444 && fabs(eta) < 1.566 && pt >= 100) return 1.03668;
        if (fabs(eta) >= 1.566 && fabs(eta) < 2 && pt >= 10 && pt < 20) return 0.983351;
        if (fabs(eta) >= 1.566 && fabs(eta) < 2 && pt >= 20 && pt < 45) return 0.98768;
        if (fabs(eta) >= 1.566 && fabs(eta) < 2 && pt >= 45 && pt < 75) return 0.990816;
        if (fabs(eta) >= 1.566 && fabs(eta) < 2 && pt >= 75 && pt < 100) return 1.01018;
        if (fabs(eta) >= 1.566 && fabs(eta) < 2 && pt >= 100) return 0.997967;
        if (fabs(eta) >= 2 && fabs(eta) < 2.5 && pt >= 10 && pt < 20) return 1.01998;
        if (fabs(eta) >= 2 && fabs(eta) < 2.5 && pt >= 20 && pt < 45) return 0.983556;
        if (fabs(eta) >= 2 && fabs(eta) < 2.5 && pt >= 45 && pt < 75) return 0.98773;
        if (fabs(eta) >= 2 && fabs(eta) < 2.5 && pt >= 75 && pt < 100) return 1.00716;
        if (fabs(eta) >= 2 && fabs(eta) < 2.5 && pt >= 100) return 0.983673;
    }
    return 0.0;
}

float ttH::getLeptonSF(int pdg_id, int year, ttH::IDLevel id_level, float pt, float eta) {
    if (abs(pdg_id) == 11) {
        float reco_eff_sf = ttH::getElecRecoEffSF(eta, pt, year);
        float loose_pog_sf = ttH::getElecPOGLooseSF(eta, pt, year);
        if (id_level == ttH::IDfakable) {
            float loose_sf = ttH::getElecLooseSF(eta, pt, year);
            return reco_eff_sf*loose_pog_sf*loose_sf;
        }
        else if (id_level == ttH::IDtight) {
            float tight_sf = ttH::getElecTightSF(eta, pt, year);
            return reco_eff_sf*loose_pog_sf*tight_sf;
        }
        else {
            throw std::runtime_error("ERROR: only loose and tight SFs available");
            return 0.0;
        }
    }
    else if (abs(pdg_id) == 13) {
        if (id_level == ttH::IDfakable) {
            return ttH::getMuonLooseSF(eta, pt, year);
        }
        else if (id_level == ttH::IDtight) {
            return ttH::getMuonTightSF(eta, pt, year);
        }
        else {
            throw std::runtime_error("ERROR: only loose and tight SFs available");
            return 0.0;
        ...
        throw std::runtime_error("ERROR: only muon and electron SFs available");
        return 0.0;
    }
}
