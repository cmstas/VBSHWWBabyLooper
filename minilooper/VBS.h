...
// makeCMS3ClassFiles("/home/users/jguiang/projects/philipVBSWWH/hadds/v2.6_SS/newSRs/createMini_Run2/vbshwwlvlvbb_c2v.root", "variable", "VBS", "tas", "vbs")
...
class VBS {
 ...
 protected: 
  ...
  int      is_cut_c3_sr_el_;
  TBranch *is_cut_c3_sr_el_branch;
  bool     is_cut_c3_sr_el_isLoaded;
  int      is_cut_c3_sr_mu_;
  TBranch *is_cut_c3_sr_mu_branch;
  bool     is_cut_c3_sr_mu_isLoaded;
  int      is_cut_c3_sr_tau_;
  TBranch *is_cut_c3_sr_tau_branch;
  bool     is_cut_c3_sr_tau_isLoaded;
  int      is_cut_c3_sr_neg_;
  TBranch *is_cut_c3_sr_neg_branch;
  bool     is_cut_c3_sr_neg_isLoaded;
  int      is_cut_sm_sr_el_;
  TBranch *is_cut_sm_sr_el_branch;
  bool     is_cut_sm_sr_el_isLoaded;
  int      is_cut_sm_sr_mu_;
  TBranch *is_cut_sm_sr_mu_branch;
  bool     is_cut_sm_sr_mu_isLoaded;
  int      is_cut_sm_sr_tau_;
  TBranch *is_cut_sm_sr_tau_branch;
  bool     is_cut_sm_sr_tau_isLoaded;
  int      is_cut_sm_sr_neg_;
  TBranch *is_cut_sm_sr_neg_branch;
  bool     is_cut_sm_sr_neg_isLoaded;
  int      is_cut_sr2_el_;
  ...
  int      is_cut_sm_sr_;
  TBranch *is_cut_sm_sr_branch;
  bool     is_cut_sm_sr_isLoaded;
  int      is_cut_c3_sr_;
  TBranch *is_cut_c3_sr_branch;
  bool     is_cut_c3_sr_isLoaded;
  int      is_cut_sr2_;
  ...
  int      is_cut_sm_sr2_;
  TBranch *is_cut_sm_sr2_branch;
  bool     is_cut_sm_sr2_isLoaded;
  int      is_cut_c3_sr2_;
  TBranch *is_cut_c3_sr2_branch;
  bool     is_cut_c3_sr2_isLoaded;
  int      is_bdt_sr_;
...
void LoadAllBranches(); 
  ...
  const int &is_cut_c3_sr_el();
  const int &is_cut_c3_sr_mu();
  const int &is_cut_c3_sr_tau();
  const int &is_cut_c3_sr_neg();
  const int &is_cut_sm_sr_el();
  const int &is_cut_sm_sr_mu();
  const int &is_cut_sm_sr_tau();
  const int &is_cut_sm_sr_neg();
  ...
  const int &is_cut_sr();
  const int &is_cut_cr();
  const int &is_cut_sm_sr();
  const int &is_cut_c3_sr();
  const int &is_cut_sr2();
  const int &is_cut_cr2();
  const int &is_cut_sm_sr2();
  const int &is_cut_c3_sr2();
  const int &is_bdt_sr();
  const int &is_bdt_cr();
